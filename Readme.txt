...
Instructions:
- Hold the left mouse button (or touch) and drag to rotate your view
- Use the scroll wheel (or pinch) to zoom in or out.
- You can press the + or - buttons to change the intervals at which each type of Kato spawns.
- The X button closes the application.
...
I built this game with mobile platforms in mind so I have a windows and an android build in the Builds folder in the Repo root. I have tested both and they work well.
...
The game does run at a very high frame rate but feel free to test it out for yourself. I also use object pooling, static batching and GPU instancing to try and minimize CPU overhead where I can. My goal here was to create a modular scalable system that is efficient and ready to expand with more complexity.